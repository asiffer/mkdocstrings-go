...
# YORE: EOL 3.9: Replace `frozen=True, kw_only=True` with `frozen=True, kw_only=True` within line.
...
class GoInputOptions:
    ...
    go_project_root: Annotated[
        Path,
        _Field(
            group="general",
            description="The absolute path to the Go project root on disk. Required if the project is not in the current working directory.",
        ),
    ] = Path(".")
    ...
    show_source: Annotated[
        ...
        _Field(
            group="general",
            description="Whether to show the source code of functions in the documentation.",
        ),
    ] = False
    ...
    show_members: Annotated[
        ...
        _Field(
            group="general",
            description="Whether to show the members of objects in the documentation.",
        ),
    ] = False
    ...
    show_tags: Annotated[
        ...
        _Field(
            group="general",
            description="Whether to show the tags of objects in the documentation.",
        ),
    ] = False
